    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group" style="color: aquamarine ; border-radius:2.5;">
            <input name="uploadedimage" type="file">
          </div>
           <button type="submit" style="box-shadow: 5ch;" id="submit" name="submit" class="btn btn-success pull-right" > Submit for Rental</button>    
        </form>
      </div>
    </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Orthodox Cars</h5>
                </div>
            </div>
        </div>
    </footer>
