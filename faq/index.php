        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Orthodox Carss gladly accepts Mastercard and Visa. Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>One of the many great things about Orthodox Cars is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental car fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Orthodox Cars gladly accepts MasterCard, Visa, and checks. We also PayTm.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
